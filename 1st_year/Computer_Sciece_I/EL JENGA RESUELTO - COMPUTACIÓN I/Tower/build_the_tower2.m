function build_the_tower2(Tower,playing, Rcm, move, show_top_options,analyze)
% It is exactly the same function as build_the_tower but setting other limits on the axes at the end of the code.
% In this way, this function is intended for visual representations by
% setting larger limits.
